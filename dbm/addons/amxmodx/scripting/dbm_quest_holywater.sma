...
public plugin_init( )
{
	register_plugin( "Diablo Mod Quest: Holy water, anyone?", "0.0.1", "Xellath" );
	
	QuestPointer = DBM_RegisterQuest( 
		"QUEST_HOLYWATER_NAME", 
		"QUEST_HOLYWATER_DESC", 
		"quest_holywater",
		20
		);
		
	ClassId = DBM_GetIdFromClassName( "CLASS_PALADIN_NAME" );

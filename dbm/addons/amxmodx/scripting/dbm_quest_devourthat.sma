...
public plugin_init( )
{
	register_plugin( "Diablo Mod Quest: Devour that, bitch!", "0.0.1", "Xellath" );
	
	QuestPointer = DBM_RegisterQuest( 
		"QUEST_DEVOURTHAT_NAME", 
		"QUEST_DEVOURTHAT_DESC", 
		"quest_devourthat",
		20
		);
		
	ClassId = DBM_GetIdFromClassName( "CLASS_NECROMANCER_NAME" );

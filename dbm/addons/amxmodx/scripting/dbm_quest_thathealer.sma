...
public plugin_init( )
{
	register_plugin( "Diablo Mod Quest: That healer... man!", "0.0.1", "Xellath" );
	
	QuestPointer = DBM_RegisterQuest( 
		"QUEST_THATHEALER_NAME", 
		"QUEST_THATHEALER_DESC", 
		"quest_thathealer",
		20
		);
		
	ClassId = DBM_GetIdFromClassName( "CLASS_CLERIC_NAME" );

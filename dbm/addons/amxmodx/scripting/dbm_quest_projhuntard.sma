...
public plugin_init( )
{
	register_plugin( "Diablo Mod Quest: Project Huntard", "0.0.1", "Xellath" );
	
	QuestPointer = DBM_RegisterQuest( 
		"QUEST_PROJHUNTARD_NAME", 
		"QUEST_PROJHUNTARD_DESC", 
		"quest_projhuntard",
		20
		);
		
	ClassId = DBM_GetIdFromClassName( "CLASS_HUNTER_NAME" );

...
public plugin_init( )
{
	register_plugin( "Diablo Mod Quest: Inner Peace? No way!", "0.0.1", "Xellath" );
	
	QuestPointer = DBM_RegisterQuest( 
		"QUEST_INNERPEACE_NAME", 
		"QUEST_INNERPEACE_DESC", 
		"quest_innerpeace",
		20
		);
		
	ClassId = DBM_GetIdFromClassName( "CLASS_MONK_NAME" );
